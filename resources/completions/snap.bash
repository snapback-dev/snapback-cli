...
# Generated by: snap completion bash
...
_snap_completions() {
    ...
    local commands="login logout whoami init status fix protect session context validate stats learn patterns watch tools mcp config doctor upgrade wizard undo alias analyze snapshot list check interactive completion daemon"
    local global_opts="--help -h --version -v --verbose --quiet -q --no-color --debug"
    ...
    local daemon_subcommands="start stop status restart ping"
